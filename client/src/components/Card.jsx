  ...
  return (
    ...
    hover:shadow-cardhover card'>
      <img className='w-full h-auto object-cover rounded-xl'
        ...
        alt={prompt}
      />
      <div className='group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 right-0 bg-[#12121261]
      m-2 p-4 rounded-md'>
        ...
        <div className='mt-5 flex justify-between items-center gap-2'>
          <div className='flex items-center gap-2'>
            <div className='w-7 h-7 rounded-full object-cover bg-green-700 flex justify-center
             items-center text-white text-xs font-bold uppercase'>{name[0]}</div>
